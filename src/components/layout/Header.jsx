...
const Header = () => {
  ...
  return (
    <header className="relative bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 backdrop-blur-xl border-b border-white/10 shadow-2xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <div className="relative group">
              ...
              <div className="relative p-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 group-hover:bg-white/20 transition-all duration-300">
          ...
          <div className="flex items-center space-x-6">
            {/* Indicador de estado */}
            <div className={`flex items-center space-x-3 px-4 py-2 rounded-full ${getStatusBgColor()} backdrop-blur-sm border border-white/10`}>
